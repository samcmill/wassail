...
#pragma once
#ifndef _WASSAIL_DATA_UMAD_HPP
#define _WASSAIL_DATA_UMAD_HPP
...
namespace wassail {
  namespace data {
    /*! \brief Data source building block for getting InfiniBand UMAD
     *  information
     */
    class umad final : public wassail::data::common {
    public:
      /*! constructor */
      umad();
      /*! destructor */
      ...
      std::string name() const { return "umad"; };

      /*! JSON type conversion
       * \param[in] j JSON object
       * \param[in,out] d
       */
      friend void from_json(const json &j, umad &d);
       ...
       * \include umad.json
       */
      friend void to_json(json &j, const umad &d);
