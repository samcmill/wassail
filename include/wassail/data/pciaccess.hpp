...
#pragma once
#ifndef _WASSAIL_DATA_PCIACCESS_HPP
#define _WASSAIL_DATA_PCIACCESS_HPP
...
namespace wassail {
  namespace data {
     ...
     *  information
     */
    class pciaccess final : public wassail::data::common {
    public:
      /*! constructor */
      pciaccess();
      /*! destructor */
      ...
      std::string name() const { return "pciaccess"; };

      /*! JSON type conversion
       * \param[in] j JSON object
       * \param[in,out] d
       */
      friend void from_json(const json &j, pciaccess &d);
       ...
       *
       * \par JSON schema
       * \include pciaccess.json
       */
      friend void to_json(json &j, const pciaccess &d);
