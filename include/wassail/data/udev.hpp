...
#pragma once
#ifndef _WASSAIL_DATA_UDEV_HPP
#define _WASSAIL_DATA_UDEV_HPP
...
namespace wassail {
  namespace data {
    /*! \brief Data source building block for getting udev information */
    class udev final : public wassail::data::common {
    public:
      /*! constructor */
      udev();
      /*! destructor */
       ...
       * \throws std::runtime_error() if required capabilities are not available
       */
       ...
       * \param[in,out] d
       */
      friend void from_json(const json &j, udev &d);
       ...
       * \include udev.json
       */
      friend void to_json(json &j, const udev &d);

    private:
      /*! Unique name for this building block */
      std::string name() const { return "udev"; };
