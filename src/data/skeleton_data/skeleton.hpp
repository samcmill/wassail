...
#pragma once
#ifndef _WASSAIL_DATA_SKELETON_HPP
#define _WASSAIL_DATA_SKELETON_HPP
...
namespace wassail {
  namespace data {
    /*! \brief Skeleton data source building block class */
    class skeleton final : public wassail::data::common {
    public:
      /*! constructor */
      skeleton();
      /*! destructor */
       ...
       * \param[in,out] d
       */
      friend void from_json(const json &j, skeleton &d);
       ...
       */
      friend void to_json(json &j, const skeleton &d);
